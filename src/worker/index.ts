...
queue.process(JOB_INDEX_DT_COMMIT, 5, unthenify(indexDtCommit))
queue.process(JOB_INDEX_TYPINGS_COMMIT, 5, unthenify(indexTypingsCommit))
queue.process(JOB_INDEX_DT_FILE_CHANGE, 10, unthenify(indexDtFileChange))
queue.process(JOB_INDEX_TYPINGS_FILE_CHANGE, 10, unthenify(indexTypingsFileChange))
